...
- `API_ID`22056986 - Get it by creating an app on [https://my.telegram.org](https://my.telegram.org)
- `API_HASH`621b3f64ef181561f5e8382657a23f0f - Get it by creating an app on [https://my.telegram.org](https://my.telegram.org)
- `BOT_TOKEN`5743390719:AAEJeW5d-DLH1_kC93snhweO2xXUcrsHUQ0 - Get it by creating a bot on [https://t.me/BotFather](https://t.me/BotFather)
- `FROM_CHATS`5779700223 - Chat ID of the chats from where to forward messages. Separated by space.
- `TO_CHATS`5779700223 - Chat ID of the chats where to forward messages. Separated by space.
...
- `SUDO_USERS`@Jedle707 - (Optional) Chat identifier of the sudo user. For multiple users use `;` as separator.
...
```
 @Jedle707;https://t.me/Jedle707;Hey! My channel is XXxxXX
```
...
- @Jedle707 `/forward` command to forward older messages. For message older than 2 days you have to login as a user and set the `TELEGRAM_SESSION` variable. Command usage - `/forward <Chat ID/Username/Message Link> <Limit, No. of Messages to forward> <ID of the last message of from chat to avoid repetition>`
